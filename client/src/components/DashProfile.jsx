...
export default function DashProfile() {
  ...
  const handleDeleteUser = async () => {
    ...
    try {
        ...
        dispatch(deleteUserFailure(error.messahe))
    }
  };
  return (
    <div className='max-w-lg mx-auto p-3 w-full'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
            <input hidden type="file"  acccept='image/*' onChange={handleImageChange} ref={filePickerRef}/>
            <div className='relative w-32 h-32 self-center cursor-pointer shadow-md overflow-hidden rounded-full' onClick={()=> filePickerRef.current.click()}>
                ...
                alt="user" 
                className={`rounded-full w-full h-full object-cover border-8 border-[lightgrey] ${imageFileUploadProgress && imageFileUploadProgress < 100 && 'opacity-60'}`}/>
            </div>
